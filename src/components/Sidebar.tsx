        ...
        <div className="sticky top-0 z-10 bg-white/85 dark:bg-surface-950/88
          ...
          <div className="flex items-center justify-between">
            <Link to="/" className="flex items-center gap-2.5 group">
              ...
              <div>
                <span className="text-base font-bold text-surface-900 dark:text-white tracking-tight">Python Cookbook</span>
              </div>
            </Link>
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-2">
                            {!section.runnable && (
                              <span className="text-amber-500 dark:text-amber-400 text-[11px]" title="需要完整 Python 环境">⚠</span>
                            )}
